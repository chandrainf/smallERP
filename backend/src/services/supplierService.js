const SupplierRepository = require('../database/repositories/supplierRepository');
...
module.exports = class SupplierService {
  ...
  /**
   * Destroy all Suppliers with those ids.
   *
   * @param {*} ids
   */
  ...
  /**
   * Finds Suppliers for Autocomplete.
   *
   * @param {*} search
   * @param {*} limit
   */
  ...
  /**
   * Finds Supplier based on the query.
   *
   * @param {*} args
   */
