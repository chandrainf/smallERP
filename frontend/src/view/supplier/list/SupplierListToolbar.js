...
class SupplierToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: supplierSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: supplierSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(SupplierToolbar);
