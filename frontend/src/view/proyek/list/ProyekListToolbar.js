...
class ProyekToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=proyek">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: proyekSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: proyekSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(ProyekToolbar);
