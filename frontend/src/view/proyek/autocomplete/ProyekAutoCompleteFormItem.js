...
import ProyekFormModal from 'view/proyek/form/ProyekFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/proyek/proyekSelectors';

class ProyekAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return ProyekService.listAutocomplete(value, limit);
  };
...
export default connect(select)(ProyekAutocompleteFormItem);
