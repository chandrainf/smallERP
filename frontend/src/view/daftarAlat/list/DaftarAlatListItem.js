...
class DaftarAlatListItem extends Component {
  valueAsArray = () => {
  ...
  displayableRecord = (record) => {
    ...
    return <div key={record.id}>{record['namaAlat']}</div>;
  };
...
export default connect(select)(DaftarAlatListItem);
