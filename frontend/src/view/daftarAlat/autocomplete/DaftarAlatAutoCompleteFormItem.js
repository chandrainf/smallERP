...
import DaftarAlatFormModal from 'view/daftarAlat/form/DaftarAlatFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/daftarAlat/daftarAlatSelectors';

class DaftarAlatAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return DaftarAlatService.listAutocomplete(value, limit);
  };
