...
class MekanikToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=mekanik">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: mekanikSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: mekanikSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(MekanikToolbar);
