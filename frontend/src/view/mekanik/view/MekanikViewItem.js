...
class MekanikViewItem extends Component {
  valueAsArray = () => {
  ...
  displayableRecord = (record) => {
    ...
    return <div key={record.id}>{record['mekanik']}</div>;
  };
...
export default connect(select)(MekanikViewItem);
