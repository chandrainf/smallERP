...
import DeklarasiFormModal from 'view/deklarasi/form/DeklarasiFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/deklarasi/deklarasiSelectors';

class DeklarasiAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return DeklarasiService.listAutocomplete(value, limit);
  };
