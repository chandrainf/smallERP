...
import KasMasukFormModal from 'view/kasMasuk/form/KasMasukFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/kasMasuk/kasMasukSelectors';

class KasMasukAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return KasMasukService.listAutocomplete(value, limit);
  };
