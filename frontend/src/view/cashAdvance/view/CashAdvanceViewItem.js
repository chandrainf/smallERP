...
import selectors from 'modules/cashAdvance/cashAdvanceSelectors';

class CashAdvanceViewItem extends Component {
  valueAsArray = () => {
...
export default connect(select)(CashAdvanceViewItem);
