...
import StatusAlatFormModal from 'view/statusAlat/form/StatusAlatFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/statusAlat/statusAlatSelectors';

class StatusAlatAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return StatusAlatService.listAutocomplete(value, limit);
  };
...
export default connect(select)(
  StatusAlatAutocompleteFormItem,
);
