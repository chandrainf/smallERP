...
import selectors from 'modules/statusAlat/statusAlatSelectors';

class StatusAlatViewItem extends Component {
  valueAsArray = () => {
...
export default connect(select)(StatusAlatViewItem);
