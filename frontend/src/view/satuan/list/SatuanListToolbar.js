...
class SatuanToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=satuan">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: satuanSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: satuanSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(SatuanToolbar);
