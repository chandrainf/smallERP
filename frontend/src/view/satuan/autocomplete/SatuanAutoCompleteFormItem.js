...
import SatuanFormModal from 'view/satuan/form/SatuanFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/satuan/satuanSelectors';

class SatuanAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return SatuanService.listAutocomplete(value, limit);
  };
...
export default connect(select)(SatuanAutocompleteFormItem);
