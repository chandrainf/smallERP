...
class PermintaanPerbaikanToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        {this.props.hasPermissionToCreate && (
          <Link to="/permintaanPerbaikan/new">
        ...
        {this.props.hasPermissionToImport && (
          <Link to="/permintaanPerbaikan/importer">
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=permintaanPerbaikan">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: permintaanPerbaikanSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: permintaanPerbaikanSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(PermintaanPerbaikanToolbar);
