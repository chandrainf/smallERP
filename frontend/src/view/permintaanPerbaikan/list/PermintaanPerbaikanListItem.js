...
class PermintaanPerbaikanListItem extends Component {
  valueAsArray = () => {
  ...
  displayableRecord = (record) => {
    ...
    return <div key={record.id}>{record['diketahui']}</div>;
  };
...
PermintaanPerbaikanListItem.propTypes = {
  value: PropTypes.any,
};
...
export default connect(select)(PermintaanPerbaikanListItem);
