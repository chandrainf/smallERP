...
class PermintaanPerbaikanViewItem extends Component {
  valueAsArray = () => {
  ...
  displayableRecord = (record) => {
    ...
    return (
      <div key={record.id}>{record['daftarAlat']}</div>
    );
  };
...
PermintaanPerbaikanViewItem.propTypes = {
...
export default connect(select)(PermintaanPerbaikanViewItem);
