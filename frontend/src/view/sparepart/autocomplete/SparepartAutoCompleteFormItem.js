...
import SparepartFormModal from 'view/sparepart/form/SparepartFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/sparepart/sparepartSelectors';

class SparepartAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return SparepartService.listAutocomplete(value, limit);
  };
