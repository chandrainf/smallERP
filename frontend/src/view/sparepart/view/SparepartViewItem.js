...
import selectors from 'modules/sparepart/sparepartSelectors';

class SparepartViewItem extends Component {
  valueAsArray = () => {
...
export default connect(select)(SparepartViewItem);
