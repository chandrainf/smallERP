...
import KeluhanFormModal from 'view/keluhan/form/KeluhanFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/keluhan/keluhanSelectors';

class KeluhanAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return KeluhanService.listAutocomplete(value, limit);
  };
...
export default connect(select)(KeluhanAutocompleteFormItem);
