...
import exporterFields from 'modules/kasMasuk/list/kasMasukListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'KAS_MASUK_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await KasMasukService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.kasMasuk.exporterFileName'),
