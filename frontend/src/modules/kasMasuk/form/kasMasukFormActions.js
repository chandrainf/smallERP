...
const actions = {
  ...
  doCreate: (values) => async (dispatch) => {
    try {
      ...
      await KasMasukService.create(values);
      ...
      Message.success(
        i18n('entities.kasMasuk.create.success'),
      );
  ...
  doUpdate: (id, values) => async (dispatch, getState) => {
    try {
      ...
      await KasMasukService.update(id, values);
      ...
      Message.success(
        i18n('entities.kasMasuk.update.success'),
      );
