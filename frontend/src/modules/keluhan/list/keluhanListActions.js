...
import exporterFields from 'modules/keluhan/list/keluhanListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'KELUHAN_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await KeluhanService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.keluhan.exporterFileName'),
