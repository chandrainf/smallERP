import listActions from 'modules/keluhan/list/keluhanListActions';
...
const actions = {
  ...
  doDestroy: (id) => async (dispatch) => {
    try {
      ...
      await KeluhanService.destroyAll([id]);
      ...
      Message.success(
        i18n('entities.keluhan.destroy.success'),
      );
  ...
  doDestroyAll: (ids) => async (dispatch) => {
    try {
      ...
      await KeluhanService.destroyAll(ids);
      ...
      Message.success(
        i18n('entities.keluhan.destroyAll.success'),
      );
