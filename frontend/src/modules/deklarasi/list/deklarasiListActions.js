...
import exporterFields from 'modules/deklarasi/list/deklarasiListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'DEKLARASI_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await DeklarasiService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.deklarasi.exporterFileName'),
