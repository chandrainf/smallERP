...
import exporterFields from 'modules/kasKeluar/list/kasKeluarListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'KAS_KELUAR_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await KasKeluarService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.kasKeluar.exporterFileName'),
