...
import exporterFields from 'modules/sparepart/list/sparepartListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'SPAREPART_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await SparepartService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.sparepart.exporterFileName'),
