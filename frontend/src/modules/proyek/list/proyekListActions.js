...
import exporterFields from 'modules/proyek/list/proyekListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'PROYEK_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await ProyekService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.proyek.exporterFileName'),
