...
import exporterFields from 'modules/permintaanPerbaikan/list/permintaanPerbaikanListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'PERMINTAAN_PERBAIKAN_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await PermintaanPerbaikanService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n(
          'entities.permintaanPerbaikan.exporterFileName',
        ),
