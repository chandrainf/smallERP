import listActions from 'modules/mekanik/list/mekanikListActions';
...
const actions = {
  ...
  doDestroy: (id) => async (dispatch) => {
    try {
      ...
      await MekanikService.destroyAll([id]);
      ...
      Message.success(
        i18n('entities.mekanik.destroy.success'),
      );
  ...
  doDestroyAll: (ids) => async (dispatch) => {
    try {
      ...
      await MekanikService.destroyAll(ids);
      ...
      Message.success(
        i18n('entities.mekanik.destroyAll.success'),
      );
