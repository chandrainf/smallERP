...
import exporterFields from 'modules/mekanik/list/mekanikListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'MEKANIK_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await MekanikService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.mekanik.exporterFileName'),
