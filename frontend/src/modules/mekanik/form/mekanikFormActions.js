...
const actions = {
  ...
  doCreate: (values) => async (dispatch) => {
    try {
      ...
      await MekanikService.create(values);
      ...
      Message.success(
        i18n('entities.mekanik.create.success'),
      );
  ...
  doUpdate: (id, values) => async (dispatch, getState) => {
    try {
      ...
      await MekanikService.update(id, values);
      ...
      Message.success(
        i18n('entities.mekanik.update.success'),
      );
