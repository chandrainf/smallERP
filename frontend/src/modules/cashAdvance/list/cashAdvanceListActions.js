...
import exporterFields from 'modules/cashAdvance/list/cashAdvanceListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'CASH_ADVANCE_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await CashAdvanceService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.cashAdvance.exporterFileName'),
