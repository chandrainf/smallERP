...
const prefix = 'CASH_ADVANCE_FORM';
...
const actions = {
  ...
  doCreate: (values) => async (dispatch) => {
    try {
      ...
      await CashAdvanceService.create(values);
      ...
      Message.success(
        i18n('entities.cashAdvance.create.success'),
      );
  ...
  doUpdate: (id, values) => async (dispatch, getState) => {
    try {
      ...
      await CashAdvanceService.update(id, values);
      ...
      Message.success(
        i18n('entities.cashAdvance.update.success'),
      );
