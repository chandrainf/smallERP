import listActions from 'modules/satuan/list/satuanListActions';
...
const actions = {
  ...
  doDestroy: (id) => async (dispatch) => {
    try {
      ...
      await SatuanService.destroyAll([id]);
      ...
      Message.success(
        i18n('entities.satuan.destroy.success'),
      );
  ...
  doDestroyAll: (ids) => async (dispatch) => {
    try {
      ...
      await SatuanService.destroyAll(ids);
      ...
      Message.success(
        i18n('entities.satuan.destroyAll.success'),
      );
