...
import exporterFields from 'modules/satuan/list/satuanListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'SATUAN_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await SatuanService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.satuan.exporterFileName'),
