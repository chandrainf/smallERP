...
import exporterFields from 'modules/daftarAlat/list/daftarAlatListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'DAFTAR_ALAT_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await DaftarAlatService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.daftarAlat.exporterFileName'),
