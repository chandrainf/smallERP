...
import exporterFields from 'modules/statusAlat/list/statusAlatListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'STATUS_ALAT_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await StatusAlatService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.statusAlat.exporterFileName'),
