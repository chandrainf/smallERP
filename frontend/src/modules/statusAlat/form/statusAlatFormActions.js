...
const actions = {
  ...
  doCreate: (values) => async (dispatch) => {
    try {
      ...
      await StatusAlatService.create(values);
      ...
      Message.success(
        i18n('entities.statusAlat.create.success'),
      );
  ...
  doUpdate: (id, values) => async (dispatch, getState) => {
    try {
      ...
      await StatusAlatService.update(id, values);
      ...
      Message.success(
        i18n('entities.statusAlat.update.success'),
      );
