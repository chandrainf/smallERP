...
import exporterFields from 'modules/cashPayment/list/cashPaymentListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'CASH_PAYMENT_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await CashPaymentService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.cashPayment.exporterFileName'),
