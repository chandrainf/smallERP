...
import exporterFields from 'modules/purchaseRequest/list/purchaseRequestListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'PURCHASE_REQUEST_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      new Exporter(
        exporterFields,
        i18n('entities.purchaseRequest.exporterFileName'),
