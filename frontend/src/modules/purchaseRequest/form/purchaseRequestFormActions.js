...
const prefix = 'PURCHASE_REQUEST_FORM';
...
const actions = {
  ...
  doCreate: (values) => async (dispatch) => {
    try {
      ...
      await PurchaseRequestService.create(values);
      ...
      Message.success(
        i18n('entities.purchaseRequest.create.success'),
      );
  ...
  doUpdate: (id, values) => async (dispatch, getState) => {
    try {
      ...
      await PurchaseRequestService.update(id, values);
      ...
      Message.success(
        i18n('entities.purchaseRequest.update.success'),
      );
